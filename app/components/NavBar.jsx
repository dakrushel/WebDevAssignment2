  ...
  return (
    <nav className="flex py-1">
        <ul className="flex space-x-4">
            <li><Link href={"/"} className="text-white hover:text-gray-200 hover:bg-blue-700 hover:border-blue-900 bg-bgray-600 border-b py-1 px-2 rounded-lg">Students</Link></li>
